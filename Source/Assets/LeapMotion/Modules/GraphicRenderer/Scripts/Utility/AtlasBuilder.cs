...
namespace Leap.Unity.GraphicalRenderer {
  ...
  public class AtlasBuilder {
...
#if UNITY_EDITOR
            UnityEditor.EditorUtility.CompressTexture(tex, _format, UnityEditor.TextureCompressionQuality.Best); // TextureCompressionQuality.Best -> UnityEditor.TextureCompressionQuality.Best to work with recent Unity Versions  
#endif
    ...
    private void prepareForPacking(LeapTextureFeature feature,
      ...
      // Update code to work with recent Unity Versions 
